...
{
  "gitBranch" : "dev",
  "gitRepository" : "https://github.com/VikyaSurve/eShopOnContainers",
  "liveUpdateIDESupport" : false,
  "projectName" : "eshoponcontainers",
  "targetProject" : "eshoponcontainers"
}
```
## Log
```
